...
## Manual Installation
1. Download the last release of the plugin ("SwagNuvei.zip ") in one of the following ways:
  - If you download the plugin from the main page (using the Code button):
	...
	3. Install the archive from **Configuration > Plugin Manager > Installed > Upload plugin**.
  - If you downloaded the plugin from the Releases page continue.
2. Install the arhive into ShopWare.
